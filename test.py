...
def test_ffdnet(**args):
	...
	for imagefile in files:
		...
		if not args['dont_save_results']:
			...
			estimgpath = os.path.join(outputdir, name+str('_%.2f'%psnr)+'_PDCNet'+extension)
...
if __name__ == "__main__":
	...
	parser.add_argument("--gray",type=str,default='True',\
	                    help='input images is gray')
	parser.add_argument('--add_noise', type=str,default='True',\
	                    help='add noise to validate image(s)')
	parser.add_argument('--logfile', type=str, default='imresults', \
	                    help='logfile to log informations')
	parser.add_argument("--input", type=str, default="./data/Set12/", \
						help='path to input image(s)')     #BSD68 Set12
